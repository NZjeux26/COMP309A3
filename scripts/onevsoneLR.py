...
def main():
    ...
    pipeline = Pipeline(steps=[
        ...
        ('classifier', OneVsOneClassifier(LogisticRegression(C=10, solver='liblinear', max_iter=1000)))  # Use Logistic Regression
    ])
    ...
    output.to_csv('../data/outputs/test_predictionsLR.csv', index=False)
    print("Test predictions saved to 'test_predictionsLR.csv'")
